        ...
        for stmt_ in full_tree.body:
            for node_ in ast.walk(stmt_):
                if isinstance(node_, ast.FunctionDef):
                    ...
                    # print(func_def_dict)
                    func_name, func_args, func_body_parts = (
                        func_def_dict["name"],
                        func_def_dict["args"],
                        func_def_dict["body"],
                    )
                    ...
                    for body_ in func_body_parts:
                        ...
                        if isinstance(body_, ast.Assign):
                            func_var_list = func_var_list + getBinOpDetails(
